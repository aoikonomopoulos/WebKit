...
Expected<NotificationPoint*, NotificationPoint::Error> NotificationPoint::create(ASCIILiteral providedPath, Function<void()>&& callback)
{
    return createWithName(ownerNamePrefix, providedPath, WTF::move(callback));
}

Expected<NotificationPoint*, NotificationPoint::Error> NotificationPoint::createWithName(ASCIILiteral providedName, ASCIILiteral providedPath, Function<void()>&& callback)
{
    Locker locker { OwnedNotificationPoint::ownedNotificationPointLock };
